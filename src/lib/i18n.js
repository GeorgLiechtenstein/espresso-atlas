...
export const tr = {
  de: {
    ...
    bodyInfo:           'Wie dicht und substanziell fühlt sich der Espresso im Mund an? 10 = sirupartig, vollmundig, schwer. 1 = wässrig, dünn, leer.',
    balanceLabel:       'Balance',
    balanceHint:        'Ausgewogen zwischen Bitter und Säure',
    balanceInfo:        'Ist der Espresso geschmacklich im Gleichgewicht? 10 = harmonisch, weder bitter noch sauer. 1 = unangenehm bitter oder stechend sauer.',
    cremaLabel:         'Crema',
    cremaHint:          'Dichte, Farbe, Persistenz',
    cremaInfo:          'Wie sieht die Crema aus? 10 = dicht, haselnussbraun, hält 30+ Sekunden. 1 = keine Crema oder dünner, blasser Schaum der sofort verschwindet.',
    ...
    yourScore:          'Score',
    dateLabel:          'Datum',
    readFullReview:     'Ganze Bewertung lesen →',
    privacyLink:        'Datenschutz / Privacy',
  ...
  en: {
    ...
    bodyInfo:           'How dense and substantial does the espresso feel in the mouth? 10 = syrupy, full-bodied, heavy. 1 = watery, thin, empty.',
    balanceLabel:       'Balance',
    balanceHint:        'Balanced between bitter and acid',
    balanceInfo:        'Is the espresso in flavour balance? 10 = harmonious, neither bitter nor sour. 1 = unpleasantly bitter or harshly acidic.',
    cremaLabel:         'Crema',
    cremaHint:          'Density, colour, persistence',
    cremaInfo:          'What does the crema look like? 10 = dense, hazelnut-brown, holds 30+ seconds. 1 = no crema or thin, pale foam that disappears instantly.',
    ...
    aboutSections: [
      ...
      {
        heading: 'How I rate',
        body: "I rate every espresso on three criteria:\n\nBody — How dense and substantial does the espresso feel in the mouth? 10 = syrupy, full-bodied, heavy. 1 = watery, thin, empty.\n\nBalance — Is the espresso in flavour balance? 10 = harmonious, neither bitter nor sour. 1 = unpleasantly bitter or harshly acidic.\n\nCrema — What does the crema look like? 10 = dense, hazelnut-brown, holds 30+ seconds. 1 = no crema or thin, pale foam that disappears instantly.",
      },
      {
